  ...
  return (
    <section id='about'>
      <div className="border-4 border-yellow-400 rounded-lg p-4 mx-2 mt-2">
        <div className='gap-4 mx-4 lg:mx-40 mt-6 mb-4 lg:mb-8 border-t-5 border-yellow-400 text-white'>
          <h2 className='text-center text-5xl my-4 py-2 text-yellow-400'>Welcome! Let me share a bit about myself!</h2>
          ...
          <p className="mt-4 text-lg shadow-lg rounded p-2 bg-gray-100 text-gray-800">
